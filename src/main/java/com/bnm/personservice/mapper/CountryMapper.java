...
public class CountryMapper {
    public Country toDto(com.bnm.personservice.entity.Country entity) {
    ...
    public com.bnm.personservice.entity.Country toEntity(CountryCreate dto) {
        com.bnm.personservice.entity.Country entity = new com.bnm.personservice.entity.Country();
